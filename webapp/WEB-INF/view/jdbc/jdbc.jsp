...
<page:mainTemplate>
<jsp:body>
    <div class="jdbc-content">

        <c:url value="/jdbcQueryAllUsers" var="jdbcQueryAllUsers" />
        <c:url value="/jdbcDelete/user/" var="jdbcDelete"/>
        <c:url value="/jdbcInsert/logstring/" var="jdbcInsert" />
        <c:url value="/jdbcSelectLogs" var="jdbcSelectLogs" />
        <%--<c:url value="/jdbcUpdate/user/username/" var="jdbcUpdate" />--%>
